...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-left', speed: 1000, intensity: 0, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-in', speed: 1000, intensity: 0, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('.buttons.style1', { style: 'fade-up', speed: 1000, intensity: 0, delay: 0, replay: false });
		onvisible.add('.image.style3', { style: 'zoom-out-image', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('.image.style1', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: false });
